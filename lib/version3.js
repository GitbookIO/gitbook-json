...
var ensureSections = require('./ensureSections');
...
function toVersion3(json) {
    if (detectVersion(json) == 3) {
        return json;
    }

    json = ensureSections(json);
    ...
    output.page = {
        ...
        previous: current.index > 0? chapterToArticle(_.find(chapters, { index: current.index - 1 })) : null,
        description: '',
